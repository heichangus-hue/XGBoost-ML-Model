...
train_file = "features_ML_POSITIVE_NEGATIVE_1_2_centre_of_mass_plddt_pae_new_15_charges_pI_entropy_frustration.csv"
...
selected_features = [
    "Ranking_Score", "Avg_Native_E", "Avg_Decoy_E", "Frustration_Index", "Global_pLDDT", "Global_PAE", "Avg_MW", "NCD", "RCO", "Norm_ALA", "Norm_ARG", "Norm_ASN", 
