...
train_file = "features_ML_POSITIVE_NEGATIVE_1_2_centre_of_mass_plddt_pae_new_15_charges.csv"
...
selected_features = [
    "Ranking_Score", "Charge", "Global_pLDDT", "Global_PAE", "Avg_MW", "NCD", "RCO", "Norm_ALA", "Norm_ARG", "Norm_ASN", 
